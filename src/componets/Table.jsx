...
const Table = () => {
  ...
  function savee() {
    axios({
      url: 'https://633600ed65d1e8ef2666e3bf.mockapi.io/myapp',
      method: 'GET',
  ...
  return (
    <div className='container p-3'>
      ...
      <button className='btn btn-success mx-1' onClick={save}>Download PDF</button>
      <button className='btn btn-success mx-1' onClick={savee}>Download Exel</button>
